            ...
            SizedBox(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(flex: 2,child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  _config.refundPolicyStatus == 1 ? FooterButton(title: 'refund_policy'.tr, route: RouteHelper.getHtmlRoute('refund-policy')) : SizedBox(),
                  SizedBox(height: _config.refundPolicyStatus == 1 ? Dimensions.PADDING_SIZE_SMALL : 0.0),

                  _config.cancellationPolicyStatus == 1 ? FooterButton(title: 'cancellation_policy'.tr, route: RouteHelper.getHtmlRoute('cancellation-policy')) : SizedBox(),
                  SizedBox(height: _config.cancellationPolicyStatus == 1 ? Dimensions.PADDING_SIZE_SMALL : 0.0),

                  _config.shippingPolicyStatus == 1 ? FooterButton(title: 'shipping_policy'.tr, route: RouteHelper.getHtmlRoute('shipping-policy')) : SizedBox(),
                  SizedBox(height: _config.shippingPolicyStatus == 1 ? Dimensions.PADDING_SIZE_SMALL : 0.0),

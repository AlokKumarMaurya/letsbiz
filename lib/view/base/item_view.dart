    ...
    return Column(children: [
      ...
      !_isNull ? _length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.PADDING_SIZE_LARGE : 0.13,
            ...
            padding: EdgeInsets.symmetric(horizontal: 10),
              decoration: BoxDecoration(
               /* gradient: LinearGradient(
                  colors: [Theme.of(context).dividerColor,Theme.of(context).dividerColor.withOpacity(0.3)],
              ...
              child:widget.showTheme1Store ? StoreWidget(store: widget.stores[index], index: index, inStore: widget.inStorePage) : ItemWidget(

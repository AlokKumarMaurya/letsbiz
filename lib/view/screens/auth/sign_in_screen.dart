                ...
                child: Container(
                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    ...
                    return Column(children: [
                      ...
                      Image.asset(Images.logo,width: 250,height: 100,),
                      ...
                      Row(
                        ...
                        children: [
                         Container(
                          ...
                          Text('sign_in'.tr.toUpperCase(), style: robotoBlack.copyWith(fontSize: 30,color: Colors.black)),
                          Container(
                      ...
                      Row(children: [
                        Expanded(
                          child: ListTile(
                            ...
                            title: Text('remember_me'.tr,style: TextStyle(
                              color: Colors.black
                            ),),

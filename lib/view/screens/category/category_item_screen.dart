            ...
            child: Column(children: [
                        ...
                        child: Column(children: [
                          ...
                          Text(
                            ...
                            style: index == catController.subCategoryIndex
                                ? robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black)
                                : robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey),
                          ),
              ...
              //  color: Theme.of(context).cardColor,
                child: TabBar(
                  ...
                  labelStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black),
                  tabs: [
                    Tab(text: 'item'.tr),

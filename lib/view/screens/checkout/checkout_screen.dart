          ...
          if(storeController.store != null) {
            for(ZoneData zData in Get.find<LocationController>().getUserAddress().zoneData) {
              ...
              if(zData.id ==  storeController.store.zoneId){
               // _isCashOnDeliveryActive = false;//zData.cashOnDelivery;
                _isCashOnDeliveryActive = zData.cashOnDelivery;
                debugPrint(_isCashOnDeliveryActive.toString()+"this is the COD value");
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        orderController.orderType != 'take_away' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            TextButton.icon(
                              onPressed: () async {
                                ...
                                if(_address != null) {
                                  ...
                                  print("_address.house is ${_address.house}");
                                  print("_address.streetNumber is ${_address.streetNumber}");
                                }
                              },
                          ...
                          DropdownButton(
                           ...
                           print("this is _houseController.3text ${locationController.getUserAddress().floor}");
                           print("this is _houseController.4text ${locationController.getUserAddress().streetNumber}");
                           print("this is _houseController.5text ${locationController.getUserAddress().additionalAddress}");
  ...
  Widget _orderPlaceButton(OrderController orderController, StoreController storeController, LocationController locationController, bool todayClosed, bool tomorrowClosed,
    ...
    return Container(
      ...
      child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
        if(true/*isTrue*/){
          if(_streetNumberController.text.isNotEmpty){
            {
            ...
            showCustomSnackBar("Address Line1 cannot be empty");
          }
        }/*else{
          showCustomSnackBar("Payment method required");
        }*/
      }
    ) : Center(child: CircularProgressIndicator()),
    );

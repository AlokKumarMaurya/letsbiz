        ...
        builder: (orderController) {
         ...
         /*   floatingActionButton: ResponsiveHelper.isDesktop(context) ? null :
          ...
          /*  bottomNavigationBar: ResponsiveHelper.isDesktop(context) ? SizedBox()
                : (orderController.showBottomSheet && orderController.runningOrderModel != null && orderController.runningOrderModel.orders.isNotEmpty) ? SizedBox() :
            BottomAppBar(
                  elevation: 15,
                  notchMargin: 5,
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      *//*Expanded(child:ResponsiveHelper.isDesktop(context) ? null :
                      (orderController.showBottomSheet && orderController.runningOrderModel != null && orderController.runningOrderModel.orders.isNotEmpty) ? SizedBox() : FloatingActionButton(
                        elevation: 5,
                        backgroundColor: _pageIndex == 2 ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
                        onPressed: () {
           ...
           /* bottomNavigationBar: ResponsiveHelper.isDesktop(context) ? SizedBox()
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    BottomNavItem(iconData:  Icons.shopping_cart, isSelected: false, onTap: () {
                      if(Get.find<SplashController>().module != null) {
                        _setPage(2);
                      }else{
                        showCustomSnackBar('please_select_any_module'.tr);

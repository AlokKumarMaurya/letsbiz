      ...
      return (_storeList != null && _storeList.length == 0) ? SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title:_storeList!=null? _storeList[0].name.isCaseInsensitiveContainsAny("pan")?"Popular Stores":(isFeatured ? 'featured_stores'.tr : isPopular ? Get.find<SplashController>().configModel.moduleConfig.module.showRestaurantText

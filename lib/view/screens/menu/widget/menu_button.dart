    ...
    return InkWell(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          //color: isLogout ? Get.find<AuthController>().isLoggedIn() ? Colors.red : Color(0xFF29abe2) : Theme.of(context).primaryColor,
           // boxShadow: [BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200], spreadRadius: 1, blurRadius: 5)],
          ),
          alignment: Alignment.center,
          child: /*isProfile ? ProfileImageWidget(size: _size) :*/ Image.asset(menu.icon, width: _size, height: _size,color:Colors.black),
        ),
        SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),

        Text(menu.title, style: robotoMedium.copyWith(fontSize:13), textAlign: TextAlign.center,),

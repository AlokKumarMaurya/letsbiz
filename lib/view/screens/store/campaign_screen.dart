...
class CampaignScreen extends StatefulWidget {
  ...
  final CampaignDatum campainIIID;
  CampaignScreen({@required this.campaign, @required this.modalId, @required this.campainIIID});
...
//debugPrint("this is the campion id ${widget.campaign.id}");
    widget.campainIIID !=null?Get.find<CampaignController>().getBasicCampaignDetails1(campaignID:widget.campainIIID !=null?widget.campainIIID.campaignId: widget.campaign.id,moduleid: widget.modalId):   Get.find<CampaignController>().getBasicCampaignDetails(campaignID:widget.campainIIID !=null?widget.campainIIID.campaignId: widget.campaign.id,moduleid: widget.modalId);
  }
          ...
          slivers: [
            ...
            ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: CustomImage(
                    ...
                    image:widget.campainIIID !=null?widget.campainIIID.image: '${Get.find<SplashController>().configModel.baseUrls.campaignImageUrl}/${widget.campaign.image}',
                  ),
                ),
              ),
            ) : SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                title: Text(
                  widget.campainIIID !=null?widget.campainIIID.title: widget.campaign.title,
